    ...
    >
      <el-tab-pane label="镜像管理" name="first" class="education-pane">
        ...
        <div class="show-list" v-loading="data.imageListLoading">
          <el-empty
            v-if="data.imageList.length === 0 && !data.imageListLoading"
            description="暂无镜像信息"
          />
          <el-table
            ...
            <el-table-column fixed="right" label="操作">
              <template v-slot="scope">
                <el-button
                  ...
                  type="primary"
                  size="small"
                  @click="checkImageDetail(scope.$index)"
                  >创建容器</el-button
                >
        ...
        <div class="show-list">
          ...
          >
            ...
            <el-table-column fixed="right" label="操作" min-width="300">
              <template v-slot="scope">
                <el-button
                  v-if="scope.row.status != 'delete' && scope.row.status != 3"
                  link
                  type="primary"
                  size="small"

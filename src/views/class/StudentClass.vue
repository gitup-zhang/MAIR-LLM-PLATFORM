...
const getCourseApplyDetail = async () => {
  ...
  data.courseApplyListLoading = false;
};
// 取消申请
...
const getEnrolledClass = async () => {
  const res = await getEnrolledClassList(
...
<template>
              ...
              <el-table-column fixed="right" label="操作" min-width="200">
                <template v-slot="scope">
                  ...
                  <el-button
                    ...
                    type="primary"
                    size="small"
                    @click="applyNewClass(scope.row.id)"
                    >班级申请</el-button
                  >
                </template>
              </el-table-column>
  ...
  <el-dialog
    ...
    center
  >
    <div class="student-class-dialog" v-loading="data.courseApplyListLoading">
      <el-empty
        v-if="data.courseApplyList.length === 0 && !data.courseApplyListLoading"
        description="暂无课程申请记录"
      />
      <el-table

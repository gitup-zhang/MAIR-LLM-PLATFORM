...
const getUserApplyRoleList = async () => {
  const res = await getRoleApplyList(
    ...
    <div class="me-container">
      ...
      <el-descriptions border>
        <el-descriptions-item :rowspan="2" :width="140" label="头像">
          ...
          />
          <el-button type="primary" @click="openUserInfoEditModal()"
            >修改我的信息</el-button
          >
      ...
      <el-row class="role-apply">
        ...
        <el-col :span="8">
          ...
          <el-button
            type="primary"
            class="ml-2"
            @click="submitRoleApply()"
            :loading="data.submitRoleApplyLoading"
            >申请</el-button
          >
        </el-col>
        <!-- 密码修改 -->
          ...
          <el-form :model="data.modifyPassword" class="w-[40rem] flex flex-row">
            ...
            <el-form-item>
              <el-button
                ...
                :loading="data.submitPasswordModifyLoading"
                >确认修改</el-button
              >
            </el-form-item>
          </el-form>
      ...
      <div class="apply-list" v-loading="data.applicationListLoading">
        <el-empty
          v-if="
            data.applicationList.length === 0 && !data.applicationListLoading
          "
          description="暂无角色申请记录"
        />
        <el-table
          ...
          <el-table-column fixed="right" label="操作">
            <template v-slot="scope">
              <el-button
                ...
                type="primary"
                size="small"
                @click="removeRoleApply(scope.row.id)"
                :loading="data.removeRoleApplyLoading"
                >取消</el-button
              >
            </template>
          </el-table-column>
      ...
      >
        ...
        <el-form-item>
          <el-button
            ...
            :loading="data.userInfoEditLoading"
            >提交修改</el-button
          >
        </el-form-item>
      </el-form>
